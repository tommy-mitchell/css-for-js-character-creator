...
import { defaultClothesColor, defaultSkinColor } from "@helpers/constants";
import {
	accessoryOptions,
	bodyOptions,
	clothesColorOptions,
...
export default function CharacterEditor() {
	...
	const [skinColor, setSkinColor] = React.useState<string>(defaultSkinColor);
	const [clothesColor, setClothesColor] = React.useState<string>(defaultClothesColor);
			...
			<MaxWidthWrapper className={styles.maxWidthWrapper}>
				<header className={styles.header}>
					...
					<p className={styles.description}>
						Customize your character's look and style using the controls below. What sort of adventure will you embark
						on?{" "}
					</p>
				</header>
